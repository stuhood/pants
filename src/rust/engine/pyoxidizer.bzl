...
# Near the top of the file, we adjust the build_path to be named something other than "build", which
# collides with build files.
set_build_path("pyembed-gen")
...
PYOXIDIZER_COMMIT = "4ef3e94762c79bba50c0db4b25f0b0f74a39268d"
